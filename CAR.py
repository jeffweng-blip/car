...
def generate_overlay_pdf():
 ...
 # 起始日期
    c.drawString(190, 660, roc_parts['year'])   # 起始年
    c.drawString(245, 660, roc_parts['month'])  # 起始月
    c.drawString(280, 660, roc_parts['day'])    # 起始日
    # 結束日期 (目前邏輯為同一天)
    c.drawString(350, 660, roc_parts['year'])   # 結束年
    c.drawString(410, 660, roc_parts['month'])  # 結束月
    c.drawString(460, 660, roc_parts['day'])    # 結束日
